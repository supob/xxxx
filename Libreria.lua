...
function WindowTable:Window(Htitle,GMtitle,toclose)
    ...
    AllPages.BackgroundColor3 = Color3.fromRGB(24, 21, 48)  -- Modificato a grigio scuro
    ...
    function Tabs:Tab(tabname)
        ...
        function ElementHandler:Button(btnText, callback)
            ...
            ButtonTitle.TextColor3 = Color3.fromRGB(255, 255, 255) -- Testo bianco per contrasto
        ...
        function ElementHandler:Toggle(togInfo, callback)
            ...
            ToggleTitle.TextColor3 = Color3.fromRGB(255, 255, 255) -- Testo bianco per contrasto
        ...
        function ElementHandler:Slider(text,min,max,start,callback)
            ...
            SliderTitle.TextColor3 = Color3.fromRGB(255, 255, 255) -- Testo bianco per contrasto
            ...
            Value.TextColor3 = Color3.fromRGB(255, 255, 255) -- Testo bianco per contrasto
        ...
        function ElementHandler:Label(text)
            ...
            LabelText.Text = text
            LabelText.TextColor3 = Color3.fromRGB(255, 255, 255) -- Testo bianco per contrasto
        ...
        function ElementHandler:Dropdown(text, list, callback)
            ...
            DropdownTitle.TextColor3 = Color3.fromRGB(255, 255, 255) -- Testo bianco per contrasto
                ...
                Option.MouseEnter:Connect(
                    function()
                        ...
                        TweenService:Create(
                            Option,
                            TweenInfo.new(.3, Enum.EasingStyle.Quart, Enum.EasingDirection.Out),
                            {TextColor3 = Color3.fromRGB(255, 255, 255)} -- Testo bianco quando ci si passa sopra
                        ):Play()
                    end
                )
                ...
                Option.MouseLeave:Connect(
                    function()
                        ...
                        TweenService:Create(
                            Option,
                            TweenInfo.new(.3, Enum.EasingStyle.Quart, Enum.EasingDirection.Out),
                            {TextColor3 = Color3.fromRGB(195, 195, 195)} -- Ripristina il colore del testo
                        ):Play()
                    end
                )
